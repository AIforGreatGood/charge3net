...
# Modified from https://github.com/peterbjorgensen/DeepDFT/blob/main/densitymodel.py
#  - Add support for spin density
...
from src.charge3net.data.layer import ShiftedSoftplus
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.readout_function = nn.Sequential(
            nn.Linear(hidden_state_size, hidden_state_size),
            ShiftedSoftplus(),
            nn.Linear(hidden_state_size, out_size),
        )
